...
class LocalModel(object):
    ...
    chatGLM2: Module
    chatglm2Tokenizer: PreTrainedTokenizer | PreTrainedTokenizerFast

    @classmethod
    def instance(cls: "type[LocalModel]"):
        if not hasattr(cls, 'chatGLM2'):
            pwd = os.getcwd()
            model_path = Path(pwd).joinpath('./model/ChatGLM2-6B-int4')
            ...
            model = model.eval()
            cls.chatGLM2 = model
            cls.chatglm2Tokenizer = tokenizer
